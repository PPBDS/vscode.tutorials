...
If you haven't already, start a new Github repository named `08-websites-1` and create a new Codespace where you will run this tutorial and complete all your work.
...
Verify that you have created a new public Github repo (called `08-websites-1`). Copy/paste the URL for the repo.
...
```
https://github.com/ppbds-student/08-websites-1
```
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ quarto create project website .
? Title (website) › A New Website
Creating project at /workspaces/08-websites-1:
  - Created _quarto.yml
  - Created .gitignore
  - Created index.qmd
  - Created about.qmd
  - Created styles.css
@ppbds-student ➜ /workspaces/08-websites-1 (main) $
````
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ ls
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ ls -a
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ git log -n 1
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ quarto render
[1/2] index.qmd
[2/2] about.qmd
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ ls _site
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ quarto preview
...
Go to your `08-websites-1` Github repository.
...
````
https://github.com/ppbds-student/08-websites-1/settings/pages
````
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ quarto publish gh-pages
? Publish site to https://ppbds-student.github.io/08-websites-1/ using gh-pages? (Y/n) › Yes
...
remote:      https://github.com/ppbds-student/08-websites-1/pull/new/gh-pages
remote:
To https://github.com/ppbds-student/08-websites-1.git
...
[✓] Published to https://ppbds-student.github.io/08-websites-1/
...
````
https://ppbds-student.github.io/08-websites-1/
````
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ ls .quarto
idx     preview xref
@ppbds-student ➜ /workspaces/08-websites-1 (main) $
````
...
````
@ppbds-student ➜ /workspaces/08-websites-1 (main) $ quarto publish
? Publish update to: › https://ppbds-student.github.io/08-websites-1/ (GitHub Pages)
From https://github.com/ppbds-student/08-websites-1
...
origin  https://github.com/ppbds-student/08-websites-1 (fetch)
origin  https://github.com/ppbds-student/08-websites-1 (push)
To https://github.com/ppbds-student/08-websites-1
