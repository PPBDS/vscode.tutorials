...
It should look something like this --- a YAML header with `execute: echo: false`, a setup chunk loading the tidyverse, and the stacked-area storm chart Gemini built. Your plotting code will differ:
...
You did not write any of this code yourself --- you described the goal and Gemini produced it. The skill you practiced is reviewing what the agent wrote and confirming that it does what you asked.
