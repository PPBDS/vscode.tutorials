...
You should be doing this tutorial in a repo named `terminal-1`. If you are not, create one and then connect to it. You may need to restart this tutorial after you do so. (Recall the rule: a tutorial's repo is named after its title, all in lower case, with spaces replaced by dashes --- "Terminal 1" becomes `terminal-1`.)
