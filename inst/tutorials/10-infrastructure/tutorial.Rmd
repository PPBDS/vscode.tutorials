...
You must do this tutorial in a Codespace created from a GitHub repo named `10-infrastructure`. If you haven't already done this, follow these steps:

1. Create a GitHub Repo: go to the [codespace-starter repo](https://github.com/ppbds-student/codespace-starter). Click the green "Use this Template" drop-down button and select "Create a new repository". Name the repo `10-infrastructure`. Then click "Create repository".

2. Create a Codespace from `10-infrastructure`: from this repo's page, click the green "Code" drop down button, select the "Codespaces" tab, and click "Create Codespace on main".
...
````
@ppbds-student ➜ /workspaces/10-infrastructure (main) $ pwd
/workspaces/10-infrastructure
@ppbds-student ➜ /workspaces/10-infrastructure (main) $ ls -a
.  ..  .devcontainer  .git
@ppbds-student ➜ /workspaces/10-infrastructure (main) $
````
...
Commit and push any remaining uncommitted files in your `10-infrastructure` Codespace. Copy/paste the URL to your `10-infrastructure` GitHub repo.
