...
You must do this tutorial in a Codespace created from a Github repo named 'github-introduction'. If you haven't already done this, follow these steps:

1. Create a GitHub Repo: go to the [codespace-starter repo] (https://github.com/ppbds-student/codespace-starter). Click the green "Use this Template" drop-down button and select "Create a new repository". On the next page name the repo `github-introduction`. Then click "Create repository".

2. Create a Codespace from `github-introduction`: From this repo's page, click the green "Code" drop down button, in the top right, then select the "Codespaces" tab and then click "Create Codespace on main".
...
1. Your `github-introduction` repository.
...
You should be in a directory named `github-introduction`. By default, creating a repo from the Codespace starter and opening a Codespace creates this root directory.
