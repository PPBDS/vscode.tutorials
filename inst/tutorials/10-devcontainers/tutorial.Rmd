...
Create and connect to a repo called `10-devcontainers`, then open it as your workspace.

Copy and paste the URL for your `10-devcontainers` repository.
...
```
https://github.com/ppbds-student/10-devcontainers
```
...
```
10-devcontainers $ pwd
/workspaces/10-devcontainer
10-devcontainers$ ls -a
.  ..  .git
10-devcontainers $
```
...
````
10-devcontainers $ cd ../codespace-starter
...
````
10-devcontainers      ppbds-student/10-devcontainers       main    Active
