...
You met the bash Terminal in the Getting Started and Introduction tutorials; this is recall. Open a new bash Terminal. Hit the `Enter` key twice --- the string that reappears each time is the **prompt**, telling you the Terminal is ready. Then run `pwd`. CP/CR.
