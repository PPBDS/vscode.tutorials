...
Time to build something of your own. In the bash Terminal, create a new file called `Dockerfile` (no extension) in your project folder, and write a simple Dockerfile that starts from a small base image and runs one command. For example:
