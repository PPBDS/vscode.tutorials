...
This is the first tutorial you should complete after **Getting Started**. It builds directly on that tutorial, deliberately repeating its most important ideas --- repetition is how these habits stick. We move slowly and explain every step.
...
The Terminal is a place where you type commands and the computer answers. In this section you will run a handful of simple, safe commands. You ran several of them --- `pwd`, `ls`, `ls -a` --- in Getting Started. Running them again is deliberate: these commands should live in your fingers, not your notes. Every question is just CP/CR.
...
You met **GitHub Copilot** --- the AI assistant built right into VS Code --- in Getting Started, where it wrote small files for you. Now give it real work. We use Copilot here because it is always available and works out of the box.
