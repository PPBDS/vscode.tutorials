...
````
website-1 $ quarto create project website .
...
````
website-2 $ quarto create project website .
...
````
website-2 $ head source-1.qmd source-2.qmd 
==> source-1.qmd <==
---
title: "Source 1"
format: html
...
````
website-2 $ tail -n 3 process_data.R
  mutate(song_artist = paste0(track, " (", artist, ")"))
...
````
website-2 $ git show --name-status HEAD
