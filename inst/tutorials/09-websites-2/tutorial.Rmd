...
You now know two reasonable ways to work with AI, and either is fine here. You can ask an AI in a chat window --- Grok, ChatGPT, Claude, and so on --- and copy/paste the code it gives you into your chunk by hand, the way we did in the earlier tutorials. Or you can let the Gemini CLI read and edit `index.qmd` for you directly, the way you learned in the `04-ai-1` tutorial. Use whichever you prefer.
