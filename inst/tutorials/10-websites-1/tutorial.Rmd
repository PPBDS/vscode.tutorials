...
In the bash Terminal, run `quarto create project website .`. Don't forget the `.` at the end of the command — it tells Quarto to place the new files in the current directory.
...
````
websites-1 $ quarto create project website .
