...
Add a `setup` code chunk which loads **tidyverse**, with `#| message: false`. Then add a second code chunk. As in the last section, use AI to produce code for a beautiful graphic using the `diamonds` tibble, and put that code in the second chunk. `Cmd/Ctrl + Shift + K`.
