...
A `.gitignore` grows one line at a time as a project accumulates generated files. Git also accepts wildcard patterns --- a single line reading `*_files` would cover both directories at once --- but exact names are easier to read and to reason about. You will meet wildcards later.
