...
You should be running this tutorial from a Codespace created from the [Codespace starter](https://github.com/PPBDS/codespace-starter). You may reuse the Codespace that you used for the `02-code` tutorial. If you do this, there may be some leftover files. Feel free to delete them.
