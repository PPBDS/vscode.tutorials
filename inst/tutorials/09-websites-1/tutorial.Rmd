...
If you haven't already, start a new Github repository named `quarto-websites-introduction` and create a new Codespace where you will run this tutorial and complete all your work.
...
Verify that you have created a new public Github repo (called `quarto-websites-introduction`). Copy/paste the URL for the repo.
...
```
https://github.com/ppbds-student/quarto-websites-introduction
```
...
````
quarto-websites-introduction $ quarto create project website .
? Title (website) › A New Website
Creating project at /workspaces/quarto-websites-introduction:
  - Created _quarto.yml
  - Created .gitignore
  - Created index.qmd
  - Created about.qmd
  - Created styles.css
quarto-websites-introduction $
````
...
````
quarto-websites-introduction $ ls
...
````
quarto-websites-introduction $ ls -a
...
````
quarto-websites-introduction $ git log -n 1
...
````
quarto-websites-introduction $ quarto render
[1/2] index.qmd
[2/2] about.qmd
...
````
quarto-websites-introduction $ ls _site
...
````
quarto-websites-introduction $ quarto preview
...
Go to your `quarto-websites-introduction` Github repository.
...
````
https://github.com/ppbds-student/quarto-websites-introduction/settings/pages
````
...
````
quarto-websites-introduction $ quarto publish gh-pages
? Publish site to https://ppbds-student.github.io/quarto-websites-introduction/ using gh-pages? (Y/n) › Yes
...
remote:      https://github.com/ppbds-student/quarto-websites-introduction/pull/new/gh-pages
remote:
To https://github.com/ppbds-student/quarto-websites-introduction.git
...
[✓] Published to https://ppbds-student.github.io/quarto-websites-introduction/
...
````
https://ppbds-student.github.io/quarto-websites-introduction/
````
...
````
quarto-websites-introduction $ ls .quarto
idx     preview xref
quarto-websites-introduction $
````
...
````
quarto-websites-introduction $ quarto publish
? Publish update to: › https://ppbds-student.github.io/quarto-websites-introduction/ (GitHub Pages)
From https://github.com/ppbds-student/quarto-websites-introduction
...
origin  https://github.com/ppbds-student/quarto-websites-introduction (fetch)
origin  https://github.com/ppbds-student/quarto-websites-introduction (push)
To https://github.com/ppbds-student/quarto-websites-introduction
