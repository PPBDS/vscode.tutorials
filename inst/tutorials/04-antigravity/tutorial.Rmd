...
You should be located in a repo called `antigravity` or something similar. If not, please set it up.
...
````
@ppbds-student ➜ /workspaces/04-ai-1 (main) $ agy
...
Ask Antigravity to create an `analysis.qmd` file. Tell it you want:
...
Ask Antigravity to create a `.gitignore` file suitable for a Quarto R project. Type something like:
