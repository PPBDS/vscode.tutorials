...
However, the CRAN package does not include the data necessary for running the tutorials. The best solution is to install the development version from [GitHub](https://github.com/) with:
